...
<li>Open Package Manager Console and navigate to BigDataBoost.API by typing cd <i>path_to_BigDataBoost.API</i></li>
...
<li>Build and run the BigDataBoost.API project</li>
</ol>
...
<li>Open <i>BigDataBoost.API</i> folder in your favorite text editor (preferably VS Code). If you get a message <i>Required assets to build and debug are missing from your project. Add them?</i>, click Yes</li>
<li>Navigate to BigDataBoost.Model and run <b>dotnet restore</b></li>
<li>Navigate to BigDataBoost.Data and run <b>dotnet restore</b></li>
<li>Navigate to BigDataBoost.API and run <b>dotnet restore</b></li>
...
<li>Modify the connection string in <i>appsettings.json</i> to reflect your database environment</li>
<li>While at BigDataBoost.API run the following commands
<ol>
<li><b>Add-Migration Initial</b></li>
<li><b>Update-Database</b></li>
</ol>
</li>
<li>While at BigDataBoost.API run <b>dotnet run</b></li>
</ol>
